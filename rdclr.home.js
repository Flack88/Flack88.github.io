...
function createSlider(slider) {
    ...
    const numActive = slider.querySelector('.active');
    const numTotal = slider.querySelector('.total');

    numTotal.innerHTML = slides.length;
...
// let bg1 = document.querySelector('.shadRDCLR');
// window.addEventListener('mousemove', function(e) {
//     let x = (e.clientX - window.innerWidth / 2) / window.innerWidth * -25;
//     let y = (e.clientY - window.innerHeight / 2) / window.innerHeight * -25;
//     console.log(x, y)  
//     bg1.style.transform = 'translate(' + x + 'px, ' + y + 'px)';
// });

// let bg2 = document.querySelector('.shadHOME');
// window.addEventListener('mousemove', function(e) {
//     let x = (e.clientX - window.innerWidth / 2) / window.innerWidth * -25;
//     let y = (e.clientY - window.innerHeight / 2) / window.innerHeight * -25;
//     console.log(x, y)  
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let shadow = document.querySelectorAll('.shadows');
